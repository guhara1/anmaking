...
function seoulOverviewPage() {
  ...
  <section class="section section-alt"><div class="container prose">
    ...
    <h2>자주 묻는 질문</h2>
    <div class="faq">
      <details><summary>서울 어느 지역까지 방문이 되나요?</summary><p>자치구와 행정동마다 방문이 닿는 권역이 다를 수 있습니다. 원하는 동네를 고른 뒤 예약 시 위치를 알려 주면 방문 여부와 걸리는 시간을 안내받을 수 있습니다.</p></details>
      <details><summary>서울에서 홈타이도 이용할 수 있나요?</summary><p>홈타이는 집이나 숙소로 받는 방문형 출장마사지를 가리키며, 서울 어느 권역에서 방문이 되는지는 예약할 때 확인하면 됩니다.</p></details>
