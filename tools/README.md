...
전제: 키 파일이 `https://anmaking.com/a8fca1ff1ef9e89a09341162c81b55a2.txt`
...
3. **요청 → 사이트맵 제출**: `https://anmaking.com/sitemap.xml`
4. **요청 → RSS 제출**: `https://anmaking.com/rss.xml`
...
| 변수 | 기본값 | 설명 |
|---|---|---|
| `HOST` | `anmaking.com` | 도메인 |
| `SCHEME` | `https` | 프로토콜 |
| `INDEXNOW_KEY` | `a8fca1ff1ef9e89a09341162c81b55a2` | IndexNow 키 |
