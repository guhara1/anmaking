...
사용법:
  ...
  python tools/indexnow.py /outcall/ /guide/   # 특정 경로만 통보(글 올릴 때마다)
  HOST=anmaking.com python tools/indexnow.py
...
# ── 설정 ───────────────────────────────────────────────
HOST = os.environ.get("HOST", "anmaking.com")
KEY = os.environ.get("INDEXNOW_KEY", "a8fca1ff1ef9e89a09341162c81b55a2")
...
def normalize(args):
    """경로(/outcall/)나 전체 URL을 절대 URL로 변환."""
    out = []
    for a in args:
